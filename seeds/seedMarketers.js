...
// const { generateReferralCode } = require("../utils/utils.js.js");

// const createAffiliateStore = async ({ userId, domain, storeName }) => {
//   console.log("\n================ CREATE AFFILIATE START ================");
...
//     /* ================================
//        3️⃣ Generate referral code ONLY if missing
//        (prevents regenerating every run)
//     ================================= */
...
//     } else {
//       console.log("🎟 Existing referral code reused:", referralCode);
//     }

//     /* ================================
//        4️⃣ Upsert store (SAFE)
//        - create if missing
//        - update if exists
//     ================================= */
//     const store = await Store.findOneAndUpdate(
//       { owner: user._id }, // one store per affiliate
//       {
//         name: storeName || `${user.username}'s Store`,
//         domains: [cleanDomain],
//         owner: user._id,
//         isDefault: false,
//         settings: {
...
//     console.log("🧑‍💼 User upgraded to marketer");

//     /* ================================
//        6️⃣ Ensure wallet exists (SAFE)
//     ================================= */
...
//     console.log("🎉 Affiliate setup complete!");
//     console.log("=====================================================\n");
//   } catch (err) {
...
// //   userId: "699a243f856d7b043b10453d",
// //   domain: "https://kwikipay-six.vercel.app/",
// //   domain: "store1.local",
// //   storeName: "KwikiPay Store",
// // });

// createAffiliateStore({
//   userId: "696d201b0441545f67bf1efa",
//   // domain: "https://fastpay-six.vercel.app/",
//   domain: "store2.local",
//   storeName: "FastPay Store",
// });

/**
 * DEVELOPMENT MARKETER SEEDER
 *
 * Creates test marketer platforms with users for local development.
 *
 * Run:
